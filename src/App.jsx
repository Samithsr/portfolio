        ...
        <div className="about-grid">
          <div className="about-text reveal">
            ...
            <ul className="contact-list">
              ...
              <li><span className="icon">📱</span> +91 9380780049</li>
              <li><span className="icon">📍</span> Bangalore, India</li>
              <li><span className="icon">🔗</span> <a href="https://linkedin.com/in/samith-s-r-b41bb926a" target="_blank">linkedin.com/in/samith-s-r</a></li>
            </ul>
          </div>
      ...
      <section id="contact">
        <div className="contact-wrapper reveal">
          ...
          <div className="contact-links">
            ...
            <a href="https://linkedin.com/in/samith-s-r-b41bb926a" target="_blank" className="contact-link">
